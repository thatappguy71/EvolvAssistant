            ...
            {marketingChannels.map((channel, index) => (
              <div key={index} className="border rounded-lg p-4 space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  <h3 className="font-semibold text-sm sm:text-base leading-tight">{channel.name}</h3>
                  <Badge 
                ...
                <div className="grid grid-cols-3 gap-2 text-xs sm:text-sm">
                  <div className="min-w-0">
                    ...
                    <div className="font-medium truncate">{channel.budget}</div>
                  </div>
                  <div className="min-w-0">
                    <div className="text-muted-foreground text-xs">Reach</div>
                    <div className="font-medium truncate">{channel.reach}</div>
                  </div>
                  <div className="min-w-0">
                    <div className="text-muted-foreground text-xs">Conv.</div>
                    <div className="font-medium truncate">{channel.conversion}</div>
                  </div>
                </div>
                
                <div className="flex flex-wrap gap-1.5">
                  {channel.platforms.map((platform, idx) => (
                    <Badge key={idx} variant="outline" className="text-xs px-2 py-0.5 leading-tight">
                      {platform}
                    </Badge>
                  ))}
                </div>
